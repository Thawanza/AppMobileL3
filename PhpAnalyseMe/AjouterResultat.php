...
if (isset($_POST['dat']) && isset($_POST['res']) && isset($_POST['utilisateur']) && isset($_POST['tel'])) {
    $valeur_col1 = $_POST['utilisateur'];
    $valeur_col2 = $_POST['dat'];
    $valeur_col3 = $_POST['res'];
    $valeur_col4 = $_POST['tel'];
    ...
    $resultat =  $connexion->exec("INSERT INTO resultat(dateresultat,resultat,utilisateur,phone) VALUES('$valeur_col2', '$valeur_col3','$valeur_col1','$valeur_col4')");
